<script setup lang="ts">
    ...
    import Playerx from '~/components/Playerx.vue';
    import Playero from '~/components/Playero.vue';
     ...
     * avoir la distance parcourut par<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<template>
  <div class="container " ref="body">
    <div class="auth-container">
       <div class="container-img">
        <Playerx intColor="#3284D2" extColor="#3284D2" width="100" height="100" />
        <Playero intColor="#fff" extColor="#39BBD3" width="80" height="80" />
       </div>
       <div class="container-sign-text">
            <h1>Login</h1>
            <p>please sign in to continue</p>
       </div>
       <NuxtLink to="https://126a-169-155-235-107.ngrok-free.app/login/google">
       ...
       <NuxtLink to="https://126a-169-155-235-107.ngrok-free.app/login/facebook">
  ...
  <div class="back">
    <Playerx intColor="#fff" extColor="#fff" width="400" height="400" style="position: fixed; left: 0;"/>
    <Playero intColor="#F5F5F5" extColor="#fff" width="300" height="300" style="position: fixed; right: 0;" />
  </div>
  </template>
